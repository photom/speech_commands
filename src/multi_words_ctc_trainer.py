...
# model_dilation
model = build_model_ctc(weight_param_path, create_model=create_model_cnn_bidirect_ctc)
model.summary()
# model_dilation
np.random.seed(19)
set_random_seed(19)
...
for i in range(0, 4):
    print(f"num:{i}")
    train_model_ctc(model, raw_data, weight_param_path,
